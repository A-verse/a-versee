...
import { Camera, PenLine, Layers, ArrowRight, Route } from "lucide-react";
...
const sections = [
  {
    ...
    description:
      "Golden hours, quiet streets, warm tones — I capture the kind of beauty that makes you pause and feel something. Every frame is a story waiting to be noticed.",
  ...
  },
  {
    ...
    description:
      "Short reflections, poetic fragments, and the kind of writing that sits quietly in your mind long after you've read it. Words are my other medium.",
  ...
  },
  {
    ...
    description:
      "Concept cards, micro-interactions, and visual experiments that push the boundaries of conventional interface design. Not every experiment ships — but every one teaches.",
        ...
        <div className="max-w-6xl mx-auto">
          <ScrollReveal>
            ...
            <p className="text-sm text-muted-foreground max-w-xl mb-20">
              Not everything I create lives inside a code editor. This is the
              space for the things that feed my soul — photography, words, and
              design experiments that don't need a deadline.
            </p>
          </ScrollReveal>
            ...
            {sections.map((section, i) => (
              <ScrollReveal key={i} delay={0.1}>
                ...
                >
                  ...
                  <div
                    className={`grid grid-cols-3 gap-2 ${i % 2 === 1 ? "md:order-1" : ""}`}
                  >
