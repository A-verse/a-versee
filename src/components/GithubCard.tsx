...
export default function GithubCard() {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="relative flex flex-col justify-between rounded-[28px] border border-border bg-card/90 backdrop-blur-xl p-7 overflow-hidden text-card-foreground"
    >
      <div className="pointer-events-none absolute -top-16 -right-16 h-48 w-48 rounded-full bg-primary/10 blur-[80px]" />
      <div className="pointer-events-none absolute -bottom-16 -left-16 h-48 w-48 rounded-full bg-accent/8 blur-[80px]" />
      ...
      <div className="relative">
        <div className="flex items-center gap-3 mb-8">
          ...
          <span className="font-serif italic text-xl text-foreground tracking-tight">
            Anjali'Github
          </span>
        </div>
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          {!loading && push && (
            <span className="flex items-center gap-1.5 rounded-full border border-border bg-background/50 px-2.5 py-0.5 text-[11px] text-foreground/80">
        ...
        {loading ? (
          ...
          <p className="text-[17px] font-semibold leading-7 text-foreground">
            "{push.message}"
          </p>
        ) : (
        ...
        {!loading && push && (
          <p className="mt-3 text-sm text-muted-foreground">
            Repo:{" "}
            {push.isPrivate ? (
              <span className="font-mono text-accent">Private work</span>
            ) : (
              <a
